...
import { LogIn, Play, BookOpen } from 'lucide-react';
            ...
            <div className="relative min-h-screen overflow-hidden bg-background text-foreground flex flex-col items-center justify-center p-6">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
                        ...
                        <button className="group flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-4 bg-card text-card-foreground border-2 border-border font-bold rounded-xl hover:bg-muted transition-all shadow-sm">
